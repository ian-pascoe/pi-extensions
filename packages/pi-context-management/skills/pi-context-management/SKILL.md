...
7. For early or repeated budget warnings, inspect full context window usage, safety margin, static standing context, and effective Tail in `/context`; adjust only the documented settings and reload Pi.
