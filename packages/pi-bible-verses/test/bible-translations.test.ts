...
import { bibleTranslationMetadata } from "../src/bible-translations.js";
import { bibleVerseMessages } from "../src/bible-verses.js";

const expectedBibleTranslationMetadata = {
  WEB: {
...
describe("Offline Bible translation data", () => {
  test("retains every complete translation provenance record", () => {
    expect(bibleTranslationMetadata).toEqual(expectedBibleTranslationMetadata);
  });
