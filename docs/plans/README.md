...
| [002 — Let Pi own compaction policy](002-correct-context-budget-accounting.md)                                     | P1       | None                                                        | DONE — Pi owns compaction policy; fresh preparation and overflow recovery verified. 133 package tests plus 15 Todo tests, typechecks, lint/format, and two-axis review pass.                                              |
