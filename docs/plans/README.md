...
| [002 — Correct context-budget accounting](002-correct-context-budget-accounting.md)                                | P1       | None                                                        | DONE — two complete estimates plus one margin; 116 tests, typecheck, lint/format, and two-axis review pass. User accepts missed-growth limits and existing overflow recovery; no new request hooks.                       |
