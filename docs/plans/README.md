...
| ------------------------------------------------------------------------------------------------------------------ | -------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [001 — Preserve Todo conversation-cache prefixes](001-preserve-todo-cache-prefix.md)                               | P1       | None; coordinate Context Management test ownership with 002 | BLOCKED — real-SDK publication probe: `triggerTurn: false` persists after the tool result but is absent from the next automatic request; visible only on the next user prompt. See `context-coexistence.test.ts`. Requires an approved delivery design; no production changes. |
