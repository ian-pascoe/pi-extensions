...
| [002 — Correct context-budget accounting](002-correct-context-budget-accounting.md)                                | P1       | None                                                        | BLOCKED — SDK probe in `test/context-budget.test.ts` shows unchanged budget-hook state with enlarged outgoing tools. Needs a separate final-request budgeting/checkpoint lifecycle design; formula unchanged.             |
